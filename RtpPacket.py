...
class RtpPacket:	
	...
	def encode(self, version, padding, extension, cc, seqnum, marker, pt, ssrc, payload):
		...
		header[0] = (header[0] | version << 6) & 0xC0; # 2 bits #8bit #11000000
		header[0] = (header[0] | padding << 5); # 1 bit #8bit #10100000
		...
		header[4] = (timestamp >> 24); # 32 bit timestamp #ABCDEF11 -> 000000AB
	...
	def payloadType(self):
		"""Return payload type."""
		pt = self.header[1] & 127 # get first 7 bits in header[1]
		return int(pt)
